...
class RPKMeans(BaseEstimator, ClusterMixin, ClassifierMixin):
    __version__ = '0.1.0'
    ...
    def __init__(self, n_clusters=8, max_iter=6, distance_threshold=0, n_jobs=-1):
        """initializer of the RPKMeans class.
    ...
    def fit(self, X, y=None):
        ...
        while num_partition < self.max_iter:
            ...
            if self.distance_threshold > 0:
                if cdist(self.centroids, old_centers).diagonal().max() < self.distance_threshold:
                    break
